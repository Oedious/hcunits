...
from hcunits_api.hcunits_api.models import Unit
from hcunits_api.hcunits_api.serializers import UnitListSerializer
from hcunits_api.hcunits_api.serializers import UnitDetailSerializer
...
class Search(APIView):
  ...
  def post(self, request, format=None):
    ...
    # click number or in one of the special powers.  If 'starting_line_only'
    # is True, then also check that the click is a 'starting_line'.
    starting_line_only = request.data.get('starting_line_only', False)
    powers = []
    power_type = None
